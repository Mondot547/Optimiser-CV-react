                            ...
                            <Row className="justify-content-md-center">
                                ...
                                <Col sm={12} lg={6} className=''>
                                    ...
                                    <Container className='mt-5'>
                                        ...
                                        <a href="tel:0620304050" target="_blank" rel="noopener noreferrer" className="text-decoration-none text-dark"><FontAwesomeIcon icon={faMobileScreenButton} /> 06.20.30.40.50</a>
                                        <iframe
